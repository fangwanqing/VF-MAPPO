...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='cmappo', choices=["rmappo", "cmappo"])
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='Cityflow', help="specify the name of environment")
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global state or concatenated obs")

    # replay buffer parameters
    parser.add_argument("--episode_length", type=int,
                        default=360, help="Max length for any episode")
    ...
    parser.add_argument("--hidden_size", type=int, default=64,
                        help="Dimension of hidden layers for actor/critic networks")
    parser.add_argument("--att_hidden_size", type=int, default=32,
                        help="Dimension of attention hidden layers for critic networks")
